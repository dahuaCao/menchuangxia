...
/* harmony import */ var _image_upload_vue_vue_type_template_id_6d7257bd_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./image-upload.vue?vue&type=template&id=6d7257bd&scoped=true& */ 232);
/* harmony import */ var _image_upload_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./image-upload.vue?vue&type=script&lang=js& */ 234);
...
/* harmony import */ var _image_upload_vue_vue_type_style_index_0_id_6d7257bd_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./image-upload.vue?vue&type=style&index=0&id=6d7257bd&lang=scss&scoped=true& */ 236);
...
var _chooseImage = function _chooseImage(_this, configs) {
  ...
  uni.chooseImage({
    ...
    success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var i, len;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                // 过滤多出的预览图片
                if (!configs.autoUpload) {_context.next = 5;break;}_context.next = 5;return (
                  uImage(_this, configs));case 5:case "end":return _context.stop();}}}, _callee, this);}));function success(_x) {return _success.apply(this, arguments);}return success;}(),
...
var uImage = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(_this, configs) {var i, len;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
            ...
            i = 0, len = _this.upload_picture_list.length;case 1:if (!(i < len)) {_context2.next = 8;break;}if (!(
            _this.upload_picture_list[i]['upload_percent'] == 0)) {_context2.next = 5;break;}_context2.next = 5;return (
              upload_file_server(_this, configs, _this.upload_picture_list, i));case 5:i++;_context2.next = 1;break;case 8:case "end":return _context2.stop();}}}, _callee2, this);}));return function uImage(_x2, _x3) {return _ref.apply(this, arguments);};}();
